...
var Unit = function (game, x, y, team, letter) {
    this.team = team;
    this.letter = letter;
    ...
    Phaser.Sprite.call(this, game, x * 40 +20, y * 40 +20, 'ship');
...
Unit.prototype.move = function(positions_y, positions_x) {
    this.position.y = this.position.y + positions_y*40 ;
    this.position.x = this.position.x + positions_x*40 ;
};
